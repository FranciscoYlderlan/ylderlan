...
export class GithubRepos {
    ...
    static async filterRepos(option = ['all']) {
        ...
        if (option.includes('code')) aux = aux.filter(repos => !utils.isUplouded(repos));

        if (option.includes('page')) aux = aux.filter(repos => utils.isUplouded(repos));
